...
function (_Component) {
  ...
  _createClass(Columns, [{
    ...
    value: function render() {
      ...
      var DEFAULT_UNIT = 'day';
      var lines = [];
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, DEFAULT_UNIT, timeSteps, function (time, nextTime) {
        var minUnitValue = time.get('date');
        var firstOfType = minUnitValue === 1;
        ...
        var classNames = 'rct-vl' + (firstOfType ? ' rct-vl-first' : '') + " rct-day-".concat(time.day(), " ") + classNamesForTime.join(' ');
