...
function (_Component) {
  ...
  _createClass(Columns, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      nextProps.lineCount === this.props.lineCount && // nextProps.minUnit === this.props.minUnit &&
      nextProps.timeSteps === this.props.timeSteps && // nextProps.height === this.props.height &&
